...
void FileWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (FileWorker::*)(int )>(_a, &FileWorker::progressChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (FileWorker::*)()>(_a, &FileWorker::finished, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (FileWorker::*)(QString )>(_a, &FileWorker::error, 2))
            return;
    }
}
...
// SIGNAL 0
void FileWorker::progressChanged(int _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void FileWorker::finished()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void FileWorker::error(QString _t1)
{
